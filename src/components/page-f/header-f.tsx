...
import { CONTAINER_F } from "@/components/page-f/frame-f";
...
/**
 * Menu w układzie zaproponowanym przez klientkę: logo + nazwa, pięć pozycji
 * i przycisk „Sprawdź ofertę”. Nagłówek jest przyklejony, ale statyczny —
 * nie nasłuchuje przewijania.
 */
export function HeaderF() {
  return (
    <header className="border-brand-100 sticky top-0 z-50 border-b bg-white/95 backdrop-blur-sm">
      <div
        className={`${CONTAINER_F} flex h-20 items-center justify-between gap-6`}
      >
        <Link
          href="/page-f"
