...
import { CONTAINER_MVP, T_LABEL_MVP } from "@/components/page-mvp/frame-mvp";
...
export function FooterMvp() {
  ...
  return (
    <footer className="border-brand-100 border-t bg-white">
      <div className={`${CONTAINER_MVP} py-16 md:py-20`}>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-12">
          ...
          <nav aria-label="Nawigacja w stopce" className="md:col-span-3">
            <p className={`${T_LABEL_MVP} text-brand-600`}>Strona</p>
          ...
          <div className="md:col-span-3">
            <p className={`${T_LABEL_MVP} text-brand-600`}>Kontakt</p>
