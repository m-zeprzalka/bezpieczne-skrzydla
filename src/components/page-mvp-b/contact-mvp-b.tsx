...
const FIELD_MVPB =
  "h-12 rounded-xl border-brand-200 bg-white text-[0.9375rem]";
      ...
      <ContainerMvpB>
        <div className="grid grid-cols-1 gap-x-10 gap-y-16 md:grid-cols-12">
          ...
          <div className="md:col-span-5">
            ...
            <address className="mt-12 flex flex-col gap-4.5 not-italic">
            ...
            <dl className="text-muted-foreground mt-8 flex flex-col gap-1.5 text-[0.8125rem]">
            ...
            <div className="border-brand-200/80 mt-10 border-t pt-9">
              <p className={`${T_LABEL_MVPB} text-brand-600`}>
          ...
          <div
            id="wycena"
            className="scroll-mt-28 md:col-span-7 md:pl-4 lg:pl-14"
          >
            <Reveal delay={0.08}>
              <form
                onSubmit={handleSubmit}
                noValidate
                className="bg-brand-50/70 rounded-[1.75rem] p-8 sm:p-10 lg:p-12"
              >
                <FieldGroup>
                  <ChipRadioGroup
