...
import { CONTAINER_MVPB } from "@/components/page-mvp-b/frame-mvp-b";
...
/**
 * Nagłówek jak w G (zaakceptowany przez klientkę), w wersji B odrobinę
 * wyższy i luźniejszy — pierwsza zapowiedź przestronnej kompozycji strony.
 */
export function HeaderMvpB() {
  return (
    <header className="border-brand-100/80 sticky top-0 z-50 border-b bg-white/95 backdrop-blur-sm">
      <div
        className={`${CONTAINER_MVPB} flex h-20 items-center justify-between gap-6 lg:h-24`}
      >
        <Link
          href="/page-mvp-b"
        ...
        >
          <Image
            ...
            loading="eager"
            fetchPriority="high"
            className="ring-brand-100 size-10 rounded-full object-cover ring-1 lg:size-11"
          />
