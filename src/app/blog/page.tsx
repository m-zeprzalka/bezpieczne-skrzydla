        ...
        <Container>
          <div className="grid grid-cols-1 gap-x-12 gap-y-12 lg:grid-cols-12">
            <div className="lg:col-span-5">
              ...
              <Reveal delay={0.1} className="mt-8 max-w-[34rem]">
                <NewsletterForm />
              </Reveal>
            </div>
            <RevealGroup as="ul" className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:col-span-7 lg:pl-6">
              {resources.map((item) => (
                <RevealItem as="li" key={item.id} className="flex flex-col rounded-card border border-brand-200/80 bg-white p-6">
                  ...
                  <h3 className="mt-2 font-display text-[1.15rem] leading-[1.3] tracking-tight text-ink">{item.title}</h3>
